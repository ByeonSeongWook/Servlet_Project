		...
		<div class = "row">
				<form method = "POST" action = "./writeAction">
						<table class = "table table-striped" style = "text-align: center; border: 1px solid #bbb;">
								...
								<tbody>
										<tr>
												<td><input type = "text" class = "form-control" palceholder = "글 제목" id = "title" name = "title" maxlength = "50"></td>
										</tr>
										<tr>	
												<td><input type = "textarea" class = "form-control" placeholder = "글 내용" id = "contents" name = "contents" style = "height: 350px;"></td>
										</tr>
										<tr>
