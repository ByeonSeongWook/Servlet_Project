...
/*
 * 		465 port 사용시 error
 * 		erorr code : Could not connect to SMTP host: smtp.gmail.com, port: 465; 오류
 * 		└──> 포트 번호 587로 변경 후 .socketFactory.class 부분을 뺌.
 * 
 * 		erorr code : Could not convert socket to TLS; 오류
 * 		└──> ssl.trust 와 ssl.protocols 를 추가함.
*/	
	...
	public int mailAuth(HttpServletRequest request) {
		...
		result = aDao.getAuth(new Authmail(user_mail, auth_num));
